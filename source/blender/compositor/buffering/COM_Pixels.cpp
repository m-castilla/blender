                            ...
                            bool is_single_elem)
{
  ...
  return PixelsImg::create(buffer, buffer_row_bytes, n_channels, rect, is_single_elem);
}

PixelsImg PixelsImg::create(
    float *buffer, size_t buffer_row_bytes, int n_channels, const rcti &rect, bool is_single_elem)
{
  ...
  size_t elem_chs_incr = is_single_elem ? 0 : elem_chs;
  ...
  return PixelsImg{is_single_elem,   rect.xmin,        rect.ymin,        rect.xmax,
                   ...
                   elem_chs,         elem_bytes,       row_elems,        col_elems,
                   row_chs,          row_jump,         row_bytes,        brow_elems,
                   brow_chs,         buffer_row_bytes, brow_chs_incr,    elem_chs_incr};
}
